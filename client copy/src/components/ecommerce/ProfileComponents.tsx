import type { ProfileProps, User as userdata } from "@/types/types";
...
export const Conta = ({ data } : ProfileProps) => {
    ...
    function onSubmitInfos(setNewData){
        return true;
    }
    ...
    return(
        <div className="space-y-6">
            ...
            <div className="bg-card text-card-foreground p-6 rounded-xl shadow-sm border border-border">
                ...
                <button onClick={() => onSubmitInfos(setNewData)} type="submit" className="bg-primary text-primary-foreground hover:opacity-90 px-6 py-2.5 rounded-lg font-semibold transition-all mt-8">
                    Salvar Alterações
                </button>
            </div>
